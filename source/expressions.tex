...
n the grammar when \tcode{\~{}} is followed by
...
as specified in Clauses~\ref{library} through~\ref{thread} of this
...
\item null pointer conversions~(\ref{conv.ptr}) from \tcode{std::nullptr_t}, and
\item null member pointer conversions~(\ref{conv.mem}) from \tcode{std::nullptr_t},
\end{itemize}
