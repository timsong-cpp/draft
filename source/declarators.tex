...
a temporary object of the cv-unqualified version of the
destination type. The result of the call
(which is a prvalue temporary expression for the constructor case) is then used
...
The reference is then bound to the temporary object.
\end{itemize}
...
In all cases except the last (i.e., creating and initializing a temporary object from the
