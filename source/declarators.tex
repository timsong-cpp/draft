...
\pnum
\indextext{type!function}%
A type of either form is a \term{function type}.\footnote{As indicated by syntax, cv-qualifiers are a \DIFdelbegin \DIFdel{signficant }\DIFdelend \DIFaddbegin \DIFadd{significant }\DIFaddend component in function return types.}
...
\begin{codeblock}
struct \DIFdelbegin \DIFdel{sometype }\DIFdelend \DIFaddbegin \DIFadd{onlydouble }\DIFaddend {
  \DIFdelbegin \DIFdel{sometype}\DIFdelend \DIFaddbegin \DIFadd{onlydouble}\DIFaddend () = delete;              // OK, but redundant
  \DIFdelbegin \DIFdel{some_type}\DIFdelend \DIFaddbegin \DIFadd{onlydouble}\DIFaddend (std::intmax_t) = delete;
  \DIFdelbegin \DIFdel{some_type}\DIFdelend \DIFaddbegin \DIFadd{onlydouble}\DIFaddend (double);
};
\end{codeblock}
