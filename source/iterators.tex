...
shall have the following as publicly accessible members, and have no other
members, if and only if \tcode{Iterator} has valid~(\ref{temp.deduct}) member
...
If \tcode{is_reference<R>::value} is \tcode{true},
