...
namespace std {
  ...
  template <class charT, class OutputIterator = \DIFdelbegin \DIFdel{osterambuf}\DIFdelend \DIFaddbegin \DIFadd{ostreambuf}\DIFaddend _iterator<charT> > class num_put;
...
wide string. The second member function shall convert the \DIFdelbegin \DIFdel{nul-terminated
}\DIFdelend \DIFaddbegin \DIFadd{null-terminated
}\DIFaddend sequence beginning at \tcode{ptr} to a wide string. The third member function
...
The second member function shall convert the \DIFdelbegin \DIFdel{nul-terminated }\DIFdelend \DIFaddbegin \DIFadd{null-terminated }\DIFaddend sequence beginning at \tcode{wptr} to
...
%DIFDELCMD <     %%%
\DIFdelend iter_type get(iter_type in, iter_type end, ios_base&,
