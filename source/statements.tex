...
condition~(\ref{stmt.select}) specifies a test, before each
...
Flowing off the end of any other function is equivalent to a \tcode{return}
with no value.
...
\indextext{initialization!local thread}%
