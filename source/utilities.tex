...
\pnum
The header \tcode{<memory>} defines several types and \DIFdelbegin \DIFdel{template functions }\DIFdelend \DIFaddbegin \DIFadd{function templates }\DIFaddend that
describe properties of pointers and pointer-like types, manage memory
for containers and other template types, and construct multiple objects in
\DIFdelbegin \DIFdel{unitialized }\DIFdelend \DIFaddbegin \DIFadd{uninitialized }\DIFaddend memory
...
namespace std {
  ...
  template <class T> \DIFdelbegin \DIFdel{class }\DIFdelend \DIFaddbegin \DIFadd{struct }\DIFaddend default_delete;
  template <class T> \DIFdelbegin \DIFdel{class }\DIFdelend \DIFaddbegin \DIFadd{struct }\DIFaddend default_delete<T[]>;
...
\returns The first \DIFdelbegin \DIFdel{template }\DIFdelend \DIFaddbegin \DIFadd{member }\DIFaddend function returns a dereferenceable pointer to \tcode{r}
...
function. The second \DIFdelbegin \DIFdel{template }\DIFdelend \DIFaddbegin \DIFadd{member }\DIFaddend function returns \tcode{std::addressof(r)}.
\end{itemdescr}
...
\DIFdelbegin \DIFdel{exits}\DIFdelend \DIFaddbegin \DIFadd{exists}\DIFaddend , otherwise \tcode{false_type}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\ctype \tcode{Alloc::propagate_on_container_swap} if such a type \DIFdelbegin \DIFdel{exits}\DIFdelend \DIFaddbegin \DIFadd{exists}\DIFaddend , otherwise \tcode{false_type}.
\end{itemdescr}
...
unique_ptr<int, D> p2(new int, d);          // \tcode{D} must be \DIFdelbegin %DIFDELCMD < \tcode{Copyconstructible}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \tcode{CopyConstructible}
\DIFaddend unique_ptr<int, D&> p3(new int, d);         // \tcode{p3} holds a reference to \tcode{d}
...
\pnum
\remarks This constructor shall not participate in overload resolution unless
\tcode{U*} is \DIFdelbegin \DIFdel{implictly }\DIFdelend \DIFaddbegin \DIFadd{implicitly }\DIFaddend convertible to \tcode{T*} and \tcode{D} is
...
of the deleter from an rvalue of type \tcode{D} shall not throw an \DIFdelbegin \DIFdel{execption}\DIFdelend \DIFaddbegin \DIFadd{exception}\DIFaddend .
...
\pnum
\returns
The first \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns
\tcode{less<unique_ptr<T, D>::pointer>()(x.get(),\\nullptr)}.
The second \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns
...
\pnum
\returns
The first \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{nullptr < x}.
The second \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{x < nullptr}.
\end{itemdescr}
...
\pnum
\returns
The first \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{!(x < nullptr)}.
The second \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{!(nullptr < x)}.
\end{itemdescr}
...
\pnum
\returns
The first \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{nullptr < a}.
The second \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{a < nullptr}.
\end{itemdescr}
...
\pnum
\returns
The first \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{!(a < nullptr)}.
The second \DIFdelbegin \DIFdel{template function }\DIFdelend \DIFaddbegin \DIFadd{function template }\DIFaddend returns \tcode{!(nullptr < a)}.
\end{itemdescr}
...
\DIFdelbegin \DIFdel{MoveConstructible}\DIFdelend \DIFaddbegin \tcode{MoveConstructible}\DIFaddend . A \term{simple call wrapper} is a call wrapper
that is \DIFdelbegin \DIFdel{CopyConstructible and CopyAssignable }\DIFdelend \DIFaddbegin \tcode{CopyConstructible} \DIFadd{and }\tcode{CopyAssignable} \DIFaddend and whose copy
...
\pnum
\tcode{reference_wrapper<T>} is a \DIFdelbegin \DIFdel{CopyConstructible and CopyAssignable }\DIFdelend \DIFaddbegin \tcode{CopyConstructible} \DIFadd{and }\tcode{CopyAssignable} \DIFaddend wrapper
...
\item \tcode{ti} is the $i^{th}$ argument in the function \DIFdelbegin \DIFdel{paramater }\DIFdelend \DIFaddbegin \DIFadd{parameter }\DIFaddend pack \tcode{bound_args},
...
namespace std {
  ...
  template <std::size_t Len,
            std::size_t Align \DIFaddbegin \DIFadd{= default-alignment}\DIFaddend >   \DIFaddbegin \DIFadd{// see \ref{meta.trans.other}
    }\DIFaddend struct aligned_storage;      
...
\DIFdelbegin \DIFdel{specialisations }\DIFdelend \DIFaddbegin \DIFadd{specializations }\DIFaddend of any of these templates.
