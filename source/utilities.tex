...
\pnum
In addition to being available via inclusion of the \tcode{<tuple>} header, each
of the three templates are available when any of the headers \tcode{<array>} or
...
the qualified-id \tcode{Ptr::element_type} is valid and denotes a
...
the qualified-id \tcode{Ptr::difference_type} is valid and denotes a
...
the qualified-id \tcode{Ptr::rebind<U>} is valid and denotes a
type~(\ref{temp.deduct}); otherwise,
...
derived from \tcode{true_type} if the qualified-id \tcode{T::allocator_type}
...
the qualified-id \tcode{Alloc::pointer} is valid and denotes a
...
the qualified-id \tcode{Alloc::const_pointer} is valid and denotes a
type~(\ref{temp.deduct}); otherwise,
...
the qualified-id \tcode{Alloc::void_pointer} is valid and denotes a
type~(\ref{temp.deduct}); otherwise,
...
the qualified-id \tcode{Alloc::const_void_pointer} is valid and denotes a
type~(\ref{temp.deduct}); otherwise,
...
the qualified-id \tcode{Alloc::difference_type} is valid and denotes a
type~(\ref{temp.deduct}); otherwise,
...
the qualified-id \tcode{Alloc::size_type} is valid and denotes a
type~(\ref{temp.deduct}); otherwise,
...
the qualified-id \tcode{Alloc::propagate_on_container_copy_assignment} is valid and denotes a
type~(\ref{temp.deduct}); otherwise
\tcode{false_type}.
\end{itemdescr}
...
the qualified-id \tcode{Alloc::propagate_on_container_move_assignment} is valid and denotes a
type~(\ref{temp.deduct}); otherwise
\tcode{false_type}.
\end{itemdescr}
...
the qualified-id \tcode{Alloc::propagate_on_container_swap} is valid and denotes a
type~(\ref{temp.deduct}); otherwise
\tcode{false_type}.
\end{itemdescr}
...
the qualified-id \tcode{Alloc::rebind<T>::other} is valid and denotes a
type~(\ref{temp.deduct}); otherwise,
...
\pnum
If the qualified-id \tcode{remove_reference_t<D>::pointer} is valid and denotes a
...
temporary object. In particular, in the example:
\begin{codeblock}
...
\item
if \tcode{T} is a class type and the qualified-id \tcode{T::result_type}
...
\item
a class type where the qualified-id \tcode{T::argument_type} is valid and
...
\item
a class type where the qualified-ids \tcode{T::first_argument_type} and
...
comprising \tcode{T}. The member typedef \tcode{type} shall denote the same
...
Finally, let \tcode{C} denote the type, if any,
