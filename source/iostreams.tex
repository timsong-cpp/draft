...
described in \DIFdelbegin \DIFdel{ths }\DIFdelend \DIFaddbegin \DIFadd{this }\DIFaddend clause. A line from \textbf{A} to \textbf{B} indicates that \textbf{A}
...
multiple \DIFdelbegin \DIFdel{occurences }\DIFdelend \DIFaddbegin \DIFadd{occurrences }\DIFaddend of default arguments.}
...
no room can be found in the put buffer enough to \DIFdelbegin \DIFdel{accomodate }\DIFdelend \DIFaddbegin \DIFadd{accommodate }\DIFaddend the
...
Behaves like
a
formatted inserter (as described in~\ref{ostream.formatted.reqmts}) of \tcode{out}.
After a
\tcode{sentry}
...
After a
\tcode{sentry}
object is constructed it inserts \tcode{n} characters starting at \tcode{s},
...
\tcode{basic_istream<charT, traits>\&} and value \tcode{out}.
\end{itemdescr}
...
\rSec2[stringstream.cons]{basic_stringstream constructors}
...
\rSec2[stringstream.members]{Member functions}
...
\DIFdelbegin \DIFdel{coverting }\DIFdelend \DIFaddbegin \DIFadd{converting }\DIFaddend as if by:
