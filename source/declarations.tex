...
for a constructor, a constant initializer for some object~(\ref{basic.start.init}),
...
with no operand or with an operand of type \tcode{void}, the declared return
type shall be \tcode{auto} and the deduced return type is \tcode{void}.
...
including those appearing in scopes nested inside the linkage specification and
not inside a nested \grammarterm{linkage-specification}.
\enterexample
...
extern "C" void f5() {
  extern void f4();             // OK: Name linkage (internal)
                                ...
                                // function type linkage (C language
                                // linkage) gotten from linkage
                                // specification.
}
