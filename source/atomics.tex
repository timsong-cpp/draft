...
namespace std {
  ...
  #define ATOMIC\DIFdelbegin \DIFdel{_LLONG_LOCK_FREE @}%DIFDELCMD < \unspec%%%
\DIFdel{@
  #define ATOMIC}\DIFdelend _POINTER_LOCK_FREE @\unspec@
...
\DIFdelbegin \DIFdel{unitialized }\DIFdelend \DIFaddbegin \DIFadd{uninitialized }\DIFaddend \tcode{atomic_flag} object has an initial state of set or clear.\enterexample
