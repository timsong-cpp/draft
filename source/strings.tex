...
namespace std {
  ...
  template<class charT, class traits, class Allocator>
    basic_istream<charT,traits>&
      operator>>(basic_istream<charT,traits>& \DIFdelbegin %DIFDELCMD < & %%%
\DIFdelend is,
                 basic_string<charT,traits,Allocator>& str);
  template<class charT, class traits, class Allocator>
    basic_ostream<charT, traits>&
      operator<<(basic_ostream<charT, traits>& \DIFdelbegin %DIFDELCMD < & %%%
\DIFdelend os,
...
\pnum
\returns \tcode{*(begin() + pos)} if \tcode{pos < size()}\DIFdelbegin \DIFdel{, otherwise }\DIFdelend \DIFaddbegin \DIFadd{. Otherwise,
returns }\DIFaddend a reference to an object of type \DIFdelbegin %DIFDELCMD < \tcode{T} %%%
\DIFdelend \DIFaddbegin \tcode{charT} \DIFaddend with value
\tcode{charT()}\DIFdelbegin \DIFdel{; the referenced value shall not be modified}\DIFdelend \DIFaddbegin \DIFadd{, where modifying the object leads to
undefined behavior}\DIFaddend .
...
\begin{itemdescr}
\pnum
\effects Calls \DIFdelbegin \DIFdel{append(str.
data, str.size()).
}\DIFdelend \DIFaddbegin \tcode{append(str)}\DIFadd{.
}\DIFaddend 
...
\begin{itemdescr}
\pnum
\effects Calls \DIFdelbegin %DIFDELCMD < \tcode{append(1, c)}%%%
\DIFdelend \DIFaddbegin \tcode{push_back(c)}\DIFaddend ;
...
\begin{itemdescr}
\pnum
\effects Calls \DIFdelbegin %DIFDELCMD < \tcode{append(il.first(), il.size())}%%%
\DIFdelend \DIFaddbegin \tcode{append(il)}\DIFaddend .
...
\pnum
\effects \DIFdelbegin \DIFdel{Calls }\DIFdelend \DIFaddbegin \DIFadd{Equivalent to }\DIFaddend \tcode{insert(pos, s, traits::length(s))}.
...
\begin{itemdescr}
\pnum
\effects Equivalent to \DIFdelbegin %DIFDELCMD < \tcode{insert(pos basic_string(n, c))}%%%
\DIFdelend \DIFaddbegin \tcode{insert(pos, basic_string(n, c))}\DIFaddend .
