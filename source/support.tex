...
\begin{itemdescr}
\added{\constraints \tcode{is_integral_v<IntType>} is \tcode{true}.}

\pnum \effects Equivalent to:
\tcode{return b = b << shift;}

\pnum
\removed{\remarks This function shall not participate in overload resolution unless
...
\begin{itemdescr}
\removed{\pnum \effects Copies an \tcode{exception} object.}
...
\begin{itemdescr}
\removed{\pnum \requires \tcode{p} shall not be a null pointer.}
\added{\pnum \expects \tcode{p} shall not be a null pointer.}
...
\removed{\pnum \requires \tcode{U} shall be \oldconcept{CopyConstructible}.}
\added{\pnum \mandates \tcode{U} shall be \oldconcept{CopyConstructible}.}
...
\begin{itemdescr}
\pnum
\removed{\effects Constructs an empty \tcode{initializer_list} object.}
