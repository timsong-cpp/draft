...
\begin{itemdescr}
\added{\pnum \constraints \tcode{is_integral_v<IntType>} is \tcode{true}.}
...
\removed{\pnum \remarks This function shall not participate in overload resolution unless
\tcode{is_integral_v<IntType>} is \tcode{true}.}
\end{itemdescr}
...
\pnum
\tcode{exception_ptr} \changed{shall satisfy}{meets} the requirements of
...
\pnum
\changed{\requires}{\expects}
\tcode{p} shall not be a null pointer.
...
\pnum 
\changed{\requires}{\expects}
\tcode{U} shall \changed{be}{meet the} \oldconcept{CopyConstructible} \added{requirements}.
