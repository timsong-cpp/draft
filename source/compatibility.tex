...
\tcode{<cstdalign>},
\tcode{<cstdbool>},
\DIFdelbegin %DIFDELCMD < \tcode{<cstding>}%%%
\DIFdelend \DIFaddbegin \tcode{<cstdint>}\DIFaddend ,
\tcode{<ctgmath>},
and
\tcode{<cuchar>}.
...
This change regularizes \DIFdelbegin \DIFdel{behavor }\DIFdelend \DIFaddbegin \DIFadd{behavior }\DIFaddend for this International Standard.
\effect
