...
namespace std {
  ...
  // \ref{concepts.object}, object concepts
  // \ref{concept.movable}, concept \libconcept{Movable}
  template<class T>
    concept Movable = @\seebelow@;

  // \ref{concept.copyable}, concept \libconcept{Copyable}
  template<class T>
    concept Copyable = @\seebelow@;

  // \ref{concept.semiregular}, concept \libconcept{Semiregular}
  template<class T>
    concept Semiregular = @\seebelow@;

  // \ref{concept.regular}, concept \libconcept{Regular}
  template<class T>
...
\rSec2[concepts.object.general]{General}
\pnum
...
\rSec2[concept.movable]{Concept \libconcept{Movable}}
...
\rSec2[concept.regular]{Concept \libconcept{Regular}}
