...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{logic_error}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{domain_error}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{invalid_argument}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{length_error}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{out_of_range}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{runtime_error}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{range_error}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{overflow_error}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{underflow_error}.}
...
\pnum
\effects
Constructs an object of class \tcode{underflow_error}.
}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of type \tcode{error_code}.}
...
\added{\pnum \constraints \tcode{is_error_code_enum_v<ErrorCodeEnum>} is \tcode{true}.}

\pnum
\ensures \tcode{*this == make_error_code(e)}.

\removed{\pnum \remarks \raggedright This constructor shall not participate in overload resolution unless\linebreak
...
\removed{\pnum \remarks \raggedright This operator shall not participate in overload resolution unless\linebreak
\tcode{is_error_code_enum_v<ErrorCodeEnum>} is \tcode{true}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of type \tcode{error_condition}.}
...
\begin{itemdescr}
\removed{\pnum \effects Constructs an object of class \tcode{system_error}.}
