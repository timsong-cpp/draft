...
\added{\constraints \tcode{is_error_code_enum_v<ErrorCodeEnum>} is \tcode{true}.}

\pnum
\ensures \tcode{*this == make_error_code(e)}.

\pnum
\removed{\remarks \raggedright This constructor shall not participate in overload resolution unless\linebreak
...
\pnum
\removed{\remarks \raggedright This operator shall not participate in overload resolution unless\linebreak
\tcode{is_error_code_enum_v<ErrorCodeEnum>} is \tcode{true}.}
