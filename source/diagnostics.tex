...
namespace std {
  ...
  \DIFaddbegin \DIFadd{const error_category}& \DIFadd{generic_category() noexcept;
  const error_category}& \DIFadd{system_category() noexcept;
}

  \DIFaddend class error_code;
...
\DIFdelbegin \DIFdel{string(what()).
find(what_arg) != string::npos.
}\DIFdelend \DIFaddbegin \tcode{string(what()).find(what_arg) != string::npos}\DIFadd{.
...
\DIFdelbegin \DIFdel{string(what()).find(what_arg) != string::npos}\DIFdelend \DIFaddbegin \tcode{string(what()).find(what_arg) != string::npos}\DIFaddend .
\end{itemdescr}
