...
\grammarterm{template-parameters} that participate in template argument
...
\enternote
Parameters with dependent types in which no \grammarterm{template-parameters}
...
and
\tcode{A}.
If a particular \tcode{P} contains no \grammarterm{template-parameters}
...
if \tcode{P} contains no \grammarterm{template-parameters} that appear
